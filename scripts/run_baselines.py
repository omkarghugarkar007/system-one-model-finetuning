...
from frontierrank.core.packing import StatePacker
from frontierrank.core.scoring import AnchoredScorer
from frontierrank.data import BM25Index, load_beir, make_signature_builder
from frontierrank.eval import ece, mrr_at_k, ndcg_at_k, paired_bootstrap, recall_at_k
...
def main():
    ...
    with Run("baselines", vars(args), tag=f"{args.dataset}-{'-'.join(sorted(want))}") as run:
        ...
        if "minilm" in want:
            from frontierrank.models.baselines import CrossEncoderReranker
        ...
        if "laya" in want:
            ...
            if args.checkpoint:
                from frontierrank.models.laya.heads import FrontierRankModel, coral_probs
                from frontierrank.models.laya.vendored import QTYPES
        ...
        if "qwen" in want:
            from frontierrank.models.baselines import QwenReranker
